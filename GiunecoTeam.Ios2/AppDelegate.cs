...
namespace GiunecoTeam.Ios2
{
    ...
    public class AppDelegate : UIApplicationDelegate
    {
        ...
        public override bool FinishedLaunching(UIApplication application, NSDictionary launchOptions)
        {
            ...
            var loginController = storyboard.InstantiateViewController("Login") as LoginViewController;
            if (loginController != null)
            {
                loginController.OnLoginSuccess += LoginViewController_OnLoginSuccess;
                this.SetRootViewController(loginController);
            }
        ...
        void LoginViewController_OnLoginSuccess(object sender, EventArgs e)
        {
            ...
            var storyboard = UIStoryboard.FromName("Main", NSBundle.MainBundle);
            var tabBarController = storyboard.InstantiateViewController("Root");
